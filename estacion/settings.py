"""
Django settings for estacion project.
...
SECRET_KEY = '51=s=x1@%5nrsw8cqs2u^-=%(@rz6vwgd_a676!(x9=4ze7x-8'

# SECURITY WARNING: don't run with debug turned on in production!
#Variable para Test (Robert):
#DEBUG = True
#Variable para Producion (Robert):
DEBUG = False
...
#Para recuperar contraseña en caso de olvido (vía email)
EMAIL_USE_TLS = True
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 25
EMAIL_HOST_USER = 'grifo.munichis@gmail.com' #Email emisor para el reestablecimiento de contraseña
EMAIL_HOST_PASSWORD = 'Grif02826' #Password del Email emisor
